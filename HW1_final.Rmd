...
---
#2015-2-3-MattGhazarian-HW1.html
...
southern <- lgas[ which(lgas$zone=='Southwest'| lgas$zone=='South-South'| lgas$zone== 'Southeast'), ]
...
#create a different dataframe of population and area data
popa <- subset(mydata, select =c("state","pop_2006","area_sq_km"))
#select the unique values to eliminate repeated values from within same state
popa2 <- unique(popa)
...
allstate4 <-transform(allstate3, Med.per.sqkm = Total.med/Area)
```
